...
echo never > /sys/kernel/mm/transparent_hugepage/defrag
	...
	if [ -z "$javainstaller" ]
	then
		wget https://oraclemirror.np.gy/jdk8/jdk-8u261-linux-x64.rpm 
	...
	if [ -z "$mysqlsvrrpm" ]
	then
		wget https://downloads.mysql.com/archives/get/p/23/file/MySQL-server-5.6.35-1.el7.x86_64.rpm
	else
	...
	if [ -z "$mysqlclirpm" ]
	then
		wget https://downloads.mysql.com/archives/get/p/23/file/MySQL-client-5.6.35-1.el7.x86_64.rpm
	else
	...
	if [ -z "$mysqlsharedrpm" ]
	then
		wget https://downloads.mysql.com/archives/get/p/23/file/MySQL-shared-5.6.35-1.el7.x86_64.rpm
	else
	...
	then
		wget https://downloads.mysql.com/archives/get/p/23/file/MySQL-shared-compat-5.6.35-1.el7.x86_64.rpm
	else
...
MYSQL_SCRIPT
	...
	wget https://archive.cloudera.com/cm5/redhat/7/x86_64/cm/5.16.2/RPMS/x86_64/cloudera-manager-daemons-5.16.2-1.cm5162.p0.7.el7.x86_64.rpm
	wget https://archive.cloudera.com/cm5/redhat/7/x86_64/cm/5.16.2/RPMS/x86_64/cloudera-manager-server-5.16.2-1.cm5162.p0.7.el7.x86_64.rpm
	wget https://archive.cloudera.com/cm5/redhat/7/x86_64/cm/5.16.2/RPMS/x86_64/cloudera-manager-server-db-2-5.16.2-1.cm5162.p0.7.el7.x86_64.rpm
